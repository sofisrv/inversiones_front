...
<div class="filtros">
  ...
  */
?>
  <label> <a ><button title="Retirar" >Retirar</button></a>
<input type="text" id="filtro1" onkeyup="myFunction()" placeholder="Buscar retiro por folio" title="Buscar retiro por folio">
</div>
  <table id="myTable">
        <tr id="t1" class="w3-teal">
          <th style="width:25%;"><h4>Folio de Retiro</h4></th>
