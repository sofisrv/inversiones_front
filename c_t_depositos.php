...
<div class="filtros">
  ...
  */
?>
  <label> <a ><button title="Retirar" >Depositar</button></a>
<input type="text" id="filtro1" onkeyup="myFunction()" placeholder="Buscar deposito por folio" title="Buscar deposito por folio">
</div>
  <table id="myTable">
        <tr id="t1" class="w3-teal">
          <th style="width:25%;"><h4>Folio de Deposito</h4></th>
          <th style="width:25%;"><h4>Fecha</h4></th>
          <th style="width:25%;"><h4>Hora</h4></th>
          <th style="width:25%;"><h4>Monto</h4></th>
        </tr>
        <tbody>
